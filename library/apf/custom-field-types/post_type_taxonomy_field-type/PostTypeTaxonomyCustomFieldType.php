 ...
 * @package     CConfiguratorAdminPageFramework
 */

if ( ! class_exists( 'CConfiguratorPostTypeTaxonomyCustomFieldType' ) ) :
/**
 ...
 */
class CConfiguratorPostTypeTaxonomyCustomFieldType extends CConfiguratorAdminPageFramework_FieldType_taxonomy {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '.sz-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllCConfiguratorAdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '.sz-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllCConfiguratorAdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
    
    // When the post type check-boxes are clicked, show/hide the corresponding taxonomy elements.
    jQuery( document ).on( 'change', '.sz-field-post_type_taxonomy .sz-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.sz-field-post_type_taxonomy' );
    ...
    jQuery( '.sz-field-post_type_taxonomy .sz-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
        jQuery( this ).trigger( 'change' );
    } );
    

    jQuery().registerCConfiguratorAdminPageFrameworkCallbacks( {
        /**
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.sz-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.sz-field-post_type_taxonomy .select_all_button_container, 
.sz-field-post_type_taxonomy .select_none_button_container
{
...
.sz-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'sz-loader' )
                    . "</label>"
                . "</div>";
