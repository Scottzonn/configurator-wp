...
if ( ! class_exists( 'CConfiguratorToggleCustomFieldType' ) ) :
/**
 ...
 */
class CConfiguratorToggleCustomFieldType extends CConfiguratorAdminPageFramework_FieldType_checkbox {
    ...
    protected function getScripts() {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.sz-field' )
                    .children( '.sz-checkbox-container-toggle' )
                    .hide();
