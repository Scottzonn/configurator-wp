...
if ( ! class_exists( 'CConfiguratorNoUISliderCustomFieldType' ) ) :
/**
 ...
 */
class CConfiguratorNoUISliderCustomFieldType extends CConfiguratorAdminPageFramework_FieldType_text {
