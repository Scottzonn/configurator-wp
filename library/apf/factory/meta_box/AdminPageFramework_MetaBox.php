...
abstract class CConfiguratorAdminPageFramework_MetaBox_Router extends CConfiguratorAdminPageFramework_Factory {
    protected $oResource;
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'sz') {
    ...
    abstract class CConfiguratorAdminPageFramework_MetaBox_Model extends CConfiguratorAdminPageFramework_MetaBox_Router {
        public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'sz') {
        ...
        public function _replyToGetSavedFormData() {
            $_oMetaData = new CConfiguratorAdminPageFramework_MetaBox_Model___PostMeta($this->___getPostID(), $this->oForm->aFieldsets);
    ...
    abstract class CConfiguratorAdminPageFramework_MetaBox_View extends CConfiguratorAdminPageFramework_MetaBox_Model {
    ...
    abstract class CConfiguratorAdminPageFramework_MetaBox_Controller extends CConfiguratorAdminPageFramework_MetaBox_View {
    ...
    abstract class CConfiguratorAdminPageFramework_MetaBox extends CConfiguratorAdminPageFramework_MetaBox_Controller {
