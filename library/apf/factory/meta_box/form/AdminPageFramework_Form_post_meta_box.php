...
class CConfiguratorAdminPageFramework_Form_post_meta_box extends CConfiguratorAdminPageFramework_Form_Meta {
    public $sStructureType = 'post_meta_box';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new CConfiguratorAdminPageFramework_Form_View___CSS_meta_box;
