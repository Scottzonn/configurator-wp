...
abstract class CConfiguratorAdminPageFramework_PageMetaBox_Router extends CConfiguratorAdminPageFramework_MetaBox_View {
    protected $oResource;
    ...
    abstract class CConfiguratorAdminPageFramework_PageMetaBox_Model extends CConfiguratorAdminPageFramework_PageMetaBox_Router {
    ...
    abstract class CConfiguratorAdminPageFramework_PageMetaBox_View extends CConfiguratorAdminPageFramework_PageMetaBox_Model {
    }
    abstract class CConfiguratorAdminPageFramework_PageMetaBox_Controller extends CConfiguratorAdminPageFramework_PageMetaBox_View {
    ...
    abstract class CConfiguratorAdminPageFramework_PageMetaBox extends CConfiguratorAdminPageFramework_PageMetaBox_Controller {
        protected $_sStructureType = 'page_meta_box';
        public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'sz') {
