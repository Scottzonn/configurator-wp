...
abstract class CConfiguratorAdminPageFramework_PostType_Router extends CConfiguratorAdminPageFramework_Factory {
    ...
    abstract class CConfiguratorAdminPageFramework_PostType_Model extends CConfiguratorAdminPageFramework_PostType_Router {
        public function __construct($oProp) {
            parent::__construct($oProp);
            ...
            if ($this->oProp->bIsAdmin) {
                ...
                if ($this->oProp->sCallerPath) {
                    new CConfiguratorAdminPageFramework_PostType_Model__FlushRewriteRules($this);
                }
            }
        }
        ...
        public function _replyToRegisterPostType() {
            ...
            new CConfiguratorAdminPageFramework_PostType_Model__SubMenuOrder($this);
        }
    ...
    abstract class CConfiguratorAdminPageFramework_PostType_View extends CConfiguratorAdminPageFramework_PostType_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            if ($this->oProp->bIsAdmin) {
        ...
        public function _replyToPrintStyle() {
            ...
            if (!empty($_sStyle)) {
                echo "<style type='text/css' id='sz-style-post-type'>" . $this->oProp->sStyle . "</style>";
            }
            $this->oProp->sStyle = '';
        }
    ...
    abstract class CConfiguratorAdminPageFramework_PostType_Controller extends CConfiguratorAdminPageFramework_PostType_View {
    ...
    abstract class CConfiguratorAdminPageFramework_PostType extends CConfiguratorAdminPageFramework_PostType_Controller {
        protected $_sStructureType = 'post_type';
        public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'sz') {
            if (empty($sPostType)) {
                return;
            }
            ...
            $this->oProp->sPostType = CConfiguratorAdminPageFramework_WPUtility::sanitizeSlug($sPostType);
            $this->oProp->aPostTypeArgs = $aArguments;
        ...
        private function _getCallerScriptPath($sCallerPath) {
            ...
            $_sPageNow = CConfiguratorAdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
            if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
                return CConfiguratorAdminPageFramework_Utility::getCallerScriptPath(__FILE__);
            }
            return null;
        }
    }
