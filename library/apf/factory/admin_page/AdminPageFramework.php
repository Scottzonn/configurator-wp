...
abstract class CConfiguratorAdminPageFramework_Router extends CConfiguratorAdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'sz') {
    ...
    public function _replyToLoadComponentsForAjax() {
        ...
        new CConfiguratorAdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
    ...
    abstract class CConfiguratorAdminPageFramework_Model_Form extends CConfiguratorAdminPageFramework_Router {
        public $aFieldErrors;
        ...
        public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            new CConfiguratorAdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
        }
    ...
    abstract class CConfiguratorAdminPageFramework_View_Form extends CConfiguratorAdminPageFramework_Model_Form {
    ...
    abstract class CConfiguratorAdminPageFramework_Controller_Form extends CConfiguratorAdminPageFramework_View_Form {
        ...
        public function getValue() {
            ...
            return CConfiguratorAdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
        }
    ...
    abstract class CConfiguratorAdminPageFramework_Model_Page extends CConfiguratorAdminPageFramework_Controller_Form {
        public function _replyToFinalizeInPageTabs() {
            ...
            foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
                ...
                $_oFormatter = new CConfiguratorAdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
    ...
    abstract class CConfiguratorAdminPageFramework_View_Page extends CConfiguratorAdminPageFramework_Model_Page {
        ...
        public function _replyToEnablePageMetaBoxes() {
            new CConfiguratorAdminPageFramework_View__PageMetaboxEnabler($this);
        }
        public function _replyToEnqueuePageAssets() {
            new CConfiguratorAdminPageFramework_View__Resource($this);
        }
        ...
        protected function _renderPage($sPageSlug, $sTabSlug = null) {
            $_oPageRenderer = new CConfiguratorAdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
            $_oPageRenderer->render();
        }
    }
    abstract class CConfiguratorAdminPageFramework_Controller_Page extends CConfiguratorAdminPageFramework_View_Page {
    ...
    abstract class CConfiguratorAdminPageFramework_Model_Menu extends CConfiguratorAdminPageFramework_Controller_Page {
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'sz') {
            parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
            new CConfiguratorAdminPageFramework_Model_Menu__RegisterMenu($this);
        }
    }
    abstract class CConfiguratorAdminPageFramework_View_Menu extends CConfiguratorAdminPageFramework_Model_Menu {
    }
    abstract class CConfiguratorAdminPageFramework_Controller_Menu extends CConfiguratorAdminPageFramework_View_Menu {
        ...
        public function addSubMenuLink(array $aSubMenuLink) {
            ...
            $_oFormatter = new CConfiguratorAdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
        ...
        public function addSubMenuPage(array $aSubMenuPage) {
            ...
            $_oFormatter = new CConfiguratorAdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
            $_aSubMenuPage = $_oFormatter->get();
            $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
        }
    }
    abstract class CConfiguratorAdminPageFramework_Model extends CConfiguratorAdminPageFramework_Controller_Menu {
    }
    abstract class CConfiguratorAdminPageFramework_View extends CConfiguratorAdminPageFramework_Model {
        public function content($sContent) {
            return $sContent;
        }
    }
    abstract class CConfiguratorAdminPageFramework_Controller extends CConfiguratorAdminPageFramework_View {
        ...
        public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
            ...
            new CConfiguratorAdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, 'isInThePage'),));
        }
        ...
        static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
            return CConfiguratorAdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
        }
    }
    abstract class CConfiguratorAdminPageFramework extends CConfiguratorAdminPageFramework_Controller {
        protected $_sStructureType = 'admin_page';
        public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'sz') {
        ...
        private function _getCallerPath($sCallerPath) {
            ...
            return 'plugins.php' === $GLOBALS['pagenow'] || isset($_GET['page']) ? CConfiguratorAdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
        }
    }
