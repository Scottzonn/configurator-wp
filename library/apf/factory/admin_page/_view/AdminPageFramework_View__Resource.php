...
class CConfiguratorAdminPageFramework_View__Resource extends CConfiguratorAdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new CConfiguratorAdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new CConfiguratorAdminPageFramework_Format_PageResource_Script($asPageScript);
