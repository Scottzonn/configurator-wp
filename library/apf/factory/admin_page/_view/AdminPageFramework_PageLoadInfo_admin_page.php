...
class CConfiguratorAdminPageFramework_PageLoadInfo_admin_page extends CConfiguratorAdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new CConfiguratorAdminPageFramework_PageLoadInfo_admin_page($oProp, $oMsg);
        return self::$_oInstance;
    }
