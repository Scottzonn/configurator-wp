...
abstract class CConfiguratorAdminPageFramework_Model__FormSubmission_Base extends CConfiguratorAdminPageFramework_Form_Utility {
    ...
    class CConfiguratorAdminPageFramework_Model__FormSubmission extends CConfiguratorAdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new CConfiguratorAdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new CConfiguratorAdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
