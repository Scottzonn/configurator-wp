...
class CConfiguratorAdminPageFramework_Model__FormSubmission__Validator_Base extends CConfiguratorAdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class CConfiguratorAdminPageFramework_Model__FormSubmission__Validator extends CConfiguratorAdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__Link', 'CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__Redirect', 'CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__Import', 'CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__Export', 'CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__Reset', 'CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
