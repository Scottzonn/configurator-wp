...
class CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__Import extends CConfiguratorAdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new CConfiguratorAdminPageFramework_ImportOptions($this->getHTTPRequestSanitized($_FILES['__import'], false), $this->getHTTPRequestSanitized($_POST['__import']));
    ...
    class CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__Export extends CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__Import {
        public $sActionHookPrefix = 'try_validation_after_';
        ...
        protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
            $_oExport = new CConfiguratorAdminPageFramework_ExportOptions($this->getHTTPRequestSanitized($this->getElementAsArray($_POST, array('__export'))), $this->oFactory->oProp->sClassName);
