...
class CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__ContactForm extends CConfiguratorAdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function ___sendEmail($aInputs, $sPressedInputNameFlat, $sSubmitSectionID) {
        ...
        $_oEmail = new CConfiguratorAdminPageFramework_FormEmail($_aEmailOptions, $aInputs, $sSubmitSectionID);
        $_bSent = $_oEmail->send();
    ...
    class CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm extends CConfiguratorAdminPageFramework_Model__FormSubmission__Validator__ContactForm {
        public $sActionHookPrefix = 'try_validation_after_';
