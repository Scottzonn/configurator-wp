...
class CConfiguratorAdminPageFramework_Format_InPageTabs extends CConfiguratorAdminPageFramework_Format_Base {
    ...
    public function get() {
        ...
        foreach (( array )$_aInPageTabs as $_sTabSlug => $_aInPageTab) {
            ...
            $_oFormatter = new CConfiguratorAdminPageFramework_Format_InPageTab($_aInPageTab, $this->sPageSlug, $this->oFactory);
