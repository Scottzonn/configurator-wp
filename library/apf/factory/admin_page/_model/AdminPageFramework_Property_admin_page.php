...
class CConfiguratorAdminPageFramework_Property_admin_page extends CConfiguratorAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'sz') {
        ...
        $GLOBALS['aCConfiguratorAdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aCConfiguratorAdminPageFramework', 'aPageClasses'));
        $GLOBALS['aCConfiguratorAdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
