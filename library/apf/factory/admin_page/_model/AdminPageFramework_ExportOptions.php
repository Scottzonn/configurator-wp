...
abstract class CConfiguratorAdminPageFramework_CustomSubmitFields extends CConfiguratorAdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
    ...
    class CConfiguratorAdminPageFramework_ExportOptions extends CConfiguratorAdminPageFramework_CustomSubmitFields {
        public $sClassName;
        public $sFileName;
        public $sFormatType;
        public $bIsDataSet;
            ...
            switch (strtolower($sFormatType)) {
                case 'text':
                    if (in_array(gettype($vData), array('array', 'object'))) {
                        echo CConfiguratorAdminPageFramework_Debug::get($vData, null, false);
                    }
                    echo $vData;
                    return;
                case 'json':
