...
class CConfiguratorAdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions {
    ...
    public function get() {
        ...
        foreach (self::$_aDefaultFieldTypeSlugs as $_sFieldTypeSlug) {
            $_sFieldTypeClassName = "CConfiguratorAdminPageFramework_FieldType_{$_sFieldTypeSlug}";
