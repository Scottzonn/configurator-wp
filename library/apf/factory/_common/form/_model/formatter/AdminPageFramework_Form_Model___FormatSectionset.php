...
class CConfiguratorAdminPageFramework_Form_Model___FormatSectionset extends CConfiguratorAdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_oCollapsibleArgumentFormatter = new CConfiguratorAdminPageFramework_Form_Model___Format_CollapsibleSection($_aSectionset['collapsible'], $_aSectionset['title']);
