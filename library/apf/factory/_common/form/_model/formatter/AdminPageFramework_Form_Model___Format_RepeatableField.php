...
class CConfiguratorAdminPageFramework_Form_Model___Format_RepeatableSection extends CConfiguratorAdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : CConfiguratorAdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class CConfiguratorAdminPageFramework_Form_Model___Format_RepeatableField extends CConfiguratorAdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
