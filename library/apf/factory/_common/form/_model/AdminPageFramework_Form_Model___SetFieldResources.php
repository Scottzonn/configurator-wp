...
class CConfiguratorAdminPageFramework_Form_Model___SetFieldResources extends CConfiguratorAdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new CConfiguratorAdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('CConfiguratorAdminPageFramework_Form_View___CSS_Form', 'CConfiguratorAdminPageFramework_Form_View___CSS_Field', 'CConfiguratorAdminPageFramework_Form_View___CSS_Section', 'CConfiguratorAdminPageFramework_Form_View___CSS_CollapsibleSection', 'CConfiguratorAdminPageFramework_Form_View___CSS_FieldError', 'CConfiguratorAdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('CConfiguratorAdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new CConfiguratorAdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new CConfiguratorAdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
