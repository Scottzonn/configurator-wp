...
class CConfiguratorAdminPageFramework_Form___SubmitNotice extends CConfiguratorAdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new CConfiguratorAdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new CConfiguratorAdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
    }
