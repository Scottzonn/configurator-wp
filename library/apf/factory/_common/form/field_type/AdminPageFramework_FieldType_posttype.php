...
class CConfiguratorAdminPageFramework_FieldType_checkbox extends CConfiguratorAdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.sz-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.sz-checkbox-label {margin-top: 0.1em;}.sz-field input[type='checkbox' ] {margin-right: 0.5em;} .sz-field-checkbox .sz-input-label-container {padding-right: 1em;}.sz-field-checkbox .sz-input-label-string{display: inline; }";
    }
    ...
    class CConfiguratorAdminPageFramework_FieldType_posttype extends CConfiguratorAdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".sz-field input[type='checkbox'] {margin-right: 0.5em;} .sz-field-posttype .sz-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
