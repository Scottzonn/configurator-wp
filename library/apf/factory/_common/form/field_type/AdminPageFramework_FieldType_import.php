...
class CConfiguratorAdminPageFramework_FieldType_import extends CConfiguratorAdminPageFramework_FieldType_submit {
...
jQuery( document ).ready( function() {
    jQuery( '.sz-field-import input[type=submit]' ).on( 'click', function( event ) {
        var _iFiles = jQuery( this ).closest( '.sz-field-import' ).find( 'input[type=file]' ).get( 0 ).files.length;
        if ( 0 === _iFiles ) {
...
JAVASCRIPT;
    ...
    protected function getStyles() {
        return ".sz-field-import input {margin-right: 0.5em;}.sz-field-import,.sz-field-import .sz-input-label-container {width: 100%;}.sz-field-import label,.form-table td fieldset.sz-fieldset .sz-field-import label { display: inline-block; width: auto;vertical-align: middle;}";
    }
