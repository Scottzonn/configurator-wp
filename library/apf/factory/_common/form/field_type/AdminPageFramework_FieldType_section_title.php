...
class CConfiguratorAdminPageFramework_FieldType_section_title extends CConfiguratorAdminPageFramework_FieldType_text {
    ...
    protected function getStyles() {
        return ".sz-section-tab .sz-field-section_title {padding: 0.5em;} .sz-section-tab .sz-field-section_title .sz-input-label-string { vertical-align: middle; margin-left: 0.2em;}.sz-section-tab .sz-fields {display: inline-block;} .sz-field.sz-field-section_title {float: none;} .sz-field.sz-field-section_title input {background-color: #fff;color: #333;border-color: #ddd;box-shadow: inset 0 1px 2px rgba(0,0,0,.07);border-width: 1px;border-style: solid;outline: 0;box-sizing: border-box;vertical-align: middle;}";
    }
