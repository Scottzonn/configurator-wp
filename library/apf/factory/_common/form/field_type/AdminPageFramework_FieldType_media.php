...
class CConfiguratorAdminPageFramework_FieldType_image extends CConfiguratorAdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerCConfiguratorAdminPageFrameworkCallbacks( { 
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Bind the event.
            var _oFieldContainer = oCloned.closest( '.sz-field' );
            ...
            setCConfiguratorAdminPageFrameworkImageUploader( 
 ...
 */
setCConfiguratorAdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).on( 'click', function() {
        ...
        window.send_to_editor           = hfCConfiguratorAdminPageFrameworkSendToEditorImage;
...
var hfCConfiguratorAdminPageFrameworkSendToEditorImage = function( sRawHTML ) {
...
setCConfiguratorAdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).on( 'click', function( e ) {
        ...
        oCConfiguratorAdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
        
        // Assign a custom select object
        wp.media.view.MediaFrame.Select = fExternalSource ? getCConfiguratorAdminPageFrameworkCustomMediaUploaderSelectObject() : oCConfiguratorAdminPageFrameworkOriginalImageUploaderSelectObject;
        ...
        _oCustomImageUploader.on( 'close', function() {
            ...
            if ( typeof( _oImage ) !== 'undefined'  ) {
                ...
                _oCustomImageUploader.state().get( 'selection' ).each( function( oAttachment, iIndex ) {
                    ...
                    var _oFieldContainer    = 'undefined' === typeof _oNewField 
                        ? jQuery( '#' + sInputID ).closest( '.sz-field' ) 
                        : _oNewField;
                    _oNewField              = jQuery( this ).addCConfiguratorAdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oCConfiguratorAdminPageFrameworkOriginalImageUploaderSelectObject;
...
removeInputValuesForImage = function( oElem ) {
    ...
    var _oImageInput = jQuery( oElem ).closest( '.sz-field' ).find( '.image-field input' );                  
    if ( _oImageInput.length <= 0 )  {
        return;
    }
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".sz-field .image_preview {border: none; clear: both; margin-top: 0.4em;margin-bottom: 0.8em;display: block; max-width: 100%;height: auto; width: inherit;} .sz-field .image_preview img { display: block;height: auto; max-width: 100%;}.widget .sz-field .image_preview {max-width: 100%;}@media only screen and ( max-width: 1200px ) {.sz-field .image_preview {max-width: 600px;} } @media only screen and ( max-width: 900px ) {.sz-field .image_preview {max-width: 440px;}}@media only screen and ( max-width: 600px ) {.sz-field .image_preview {max-width: 300px;}} @media only screen and ( max-width: 480px ) {.sz-field .image_preview {max-width: 240px;}}@media only screen and ( min-width: 1200px ) {.sz-field .image_preview {max-width: 600px;}}.sz-field-image input {margin-right: 0.5em;vertical-align: middle;}.select_image.button.button-small,.remove_image.button.button-small{ vertical-align: middle;}.remove_image.button.button-small {margin-left: 0.2em;}@media screen and (max-width: 782px) {.sz-field-image input {margin: 0.5em 0.5em 0.5em 0;}}";
    }
...
jQuery( document ).ready( function(){     
    setCConfiguratorAdminPageFrameworkImageUploader( '{$sInputID}', 'true' === '{$_sRepeatable}', 'true' === '{$_bExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='sz-image-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='sz-{$sType}-remove-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
    ...
    class CConfiguratorAdminPageFramework_FieldType_media extends CConfiguratorAdminPageFramework_FieldType_image {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerCConfiguratorAdminPageFrameworkCallbacks( {    
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            setCConfiguratorAdminPageFrameworkMediaUploader( 
        ...
        private function _getScript_MediaUploader($sReferrer) {
            ...
            if (!function_exists('wp_enqueue_media')) {
                return <<<JAVASCRIPTS
                     ...
                     * The fMultiple parameter does not do anything. It is there to be consistent with the one for the WordPress version 3.5 or above.
                     */
                    setCConfiguratorAdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                        ...
                        jQuery( '#select_media_' + sInputID ).on( 'click', function() {
                            ...
                            window.original_send_to_editor = window.send_to_editor;
                            window.send_to_editor = hfCConfiguratorAdminPageFrameworkSendToEditorMedia;
                            var fExternalSource = jQuery( this ).attr( 'data-enable_external_source' );
                            tb_show( '{$_sThickBoxTitle}', 'media-upload.php?post_id=1&amp;enable_external_source=' + fExternalSource + '&amp;referrer={$sReferrer}&amp;button_label={$_sThickBoxButtonUseThis}&amp;type=image&amp;TB_iframe=true', false );
                            return false; // do not click the button after the script by returning false.     
                        });    
                    ...
                    var hfCConfiguratorAdminPageFrameworkSendToEditorMedia = function( sRawHTML, param ) {
            ...
            return <<<JAVASCRIPTS
                ...
                setCConfiguratorAdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                    ...
                    jQuery( '#select_media_' + sInputID ).on( 'click', function( e ) {
                        ...
                        // Store the original select object in a global variable
                        oCConfiguratorAdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;
                        
                        // Assign a custom select object.
                        wp.media.view.MediaFrame.Select = fExternalSource ? getCConfiguratorAdminPageFrameworkCustomMediaUploaderSelectObject() : oCConfiguratorAdminPageFrameworkOriginalMediaUploaderSelectObject;
                        ...
                        _oMediaUploader.on( 'close', function() {
                            ...
                            // Restore the original select object.
                            wp.media.view.MediaFrame.Select = oCConfiguratorAdminPageFrameworkOriginalMediaUploaderSelectObject;    
                ...
                removeInputValuesForMedia = function( oElem ) {
                    ...
                    var _oImageInput = jQuery( oElem ).closest( '.sz-field' ).find( '.media-field input' );                  
                    if ( _oImageInput.length <= 0 )  {
                        return;
                    }
...
JAVASCRIPTS;
        ...
        protected function getStyles() {
            return ".sz-field-media input {margin-right: 0.5em;vertical-align: middle;}@media screen and (max-width: 782px) {.sz-field-media input {margin: 0.5em 0.5em 0.5em 0;}} .select_media.button.button-small,.remove_media.button.button-small{ vertical-align: middle;}.remove_media.button.button-small {margin-left: 0.2em;}";
        }
        protected function _getPreviewContainer($aField, $sImageURL, $aPreviewAtrributes) {
            return "";
        }
...
jQuery( document ).ready( function(){   
    setCConfiguratorAdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}', 'true' === '{$_sExternalSource}' );
});
JAVASCRIPTS;
            return "<script type='text/javascript' class='sz-media-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
        }
