...
class CConfiguratorAdminPageFramework_FieldType_submit extends CConfiguratorAdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".sz-field input[type='submit'] {margin-bottom: 0.5em;}.sz-field-submit .submit-confirm-container {display: inline-block;margin-left: 1em;vertical-align: middle;}.sz-field-submit .field-error.submit-confirmation-warning {float: none;}";
    }
    protected function getScripts() {
        return <<<JAVASCRIPTS
jQuery( document ).ready( function(){
    jQuery( '.sz-field-submit .submit-confirm-container input[type=checkbox]' ).each( function( index, value ){
        jQuery( this ).closest( '.sz-field-submit' ).find( 'input[type=submit]' ).on( 'click', function( event ){
            var _fieldSubmit = jQuery( this ).closest( '.sz-field-submit' );  
            _fieldSubmit.find( '.submit-confirmation-warning' ).remove(); // previous error message
            var _confirmCheckbox = jQuery( this ).closest( '.sz-field-submit' ).find( '.submit-confirm-container input[type=checkbox]' );
...
JAVASCRIPTS;
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'sz-input-label-container' . ' sz-input-button-container' . ' sz-input-container',);
    }
    ...
    class CConfiguratorAdminPageFramework_FieldType_export extends CConfiguratorAdminPageFramework_FieldType_submit {
