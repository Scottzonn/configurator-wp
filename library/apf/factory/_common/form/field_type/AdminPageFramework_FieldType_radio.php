...
class CConfiguratorAdminPageFramework_FieldType_radio extends CConfiguratorAdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".sz-field input[type='radio'] {margin-right: 0.5em;} .sz-field-radio .sz-input-label-container {padding-right: 1em;} .sz-field-radio .sz-input-container {display: inline;} .sz-field-radio .sz-input-label-string{display: inline; }";
    }
    ...
    jQuery().registerCConfiguratorAdminPageFrameworkCallbacks( { 
        ...
        repeated_field: function( oCloned, aModel ) {            
            oCloned.find( 'input[type=radio]' )
                ...
                jQuery( this ).closest( '.sz-field' ).find( 'input[type=radio]' )
                    .prop( 'checked', false )
                    .attr( 'checked', false ); 
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).on( 'change', function( e ) {
        ...
        // Uncheck the other radio buttons
        jQuery( this ).closest( '.sz-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' )
            .prop( 'checked', false )
            .attr( 'checked', false );
