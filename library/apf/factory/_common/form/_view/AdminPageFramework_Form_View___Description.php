...
class CConfiguratorAdminPageFramework_Form_View___Description extends CConfiguratorAdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'sz-form-element-description';
