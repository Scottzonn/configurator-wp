...
class CConfiguratorAdminPageFramework_Form_View___Script_Form extends CConfiguratorAdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeCConfiguratorAdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.sz-form-loading' ).remove();
        jQuery( '.sz-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.sz-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeCConfiguratorAdminPageFrameworkLoadingOutputs();
