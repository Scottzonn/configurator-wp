...
class CConfiguratorAdminPageFramework_Form_View___Script_SectionTab extends CConfiguratorAdminPageFramework_Form_View___Script_Base {
...
jQuery( '.sz-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='sz-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
