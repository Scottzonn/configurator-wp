...
class CConfiguratorAdminPageFramework_Form_View___Generate_FieldTagID extends CConfiguratorAdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class CConfiguratorAdminPageFramework_Form_View___Generate_FieldInputID extends CConfiguratorAdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';
