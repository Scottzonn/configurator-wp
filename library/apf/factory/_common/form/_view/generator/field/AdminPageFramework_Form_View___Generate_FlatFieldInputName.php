...
class CConfiguratorAdminPageFramework_Form_View___Generate_FieldInputName extends CConfiguratorAdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';
    ...
    class CConfiguratorAdminPageFramework_Form_View___Generate_FlatFieldInputName extends CConfiguratorAdminPageFramework_Form_View___Generate_FieldInputName {
        public function get() {
            $_sIndex = $this->getAOrB('0' !== $this->sIndex && empty($this->sIndex), '', "|{$this->sIndex}");
