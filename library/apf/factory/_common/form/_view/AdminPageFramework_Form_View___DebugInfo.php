...
class CConfiguratorAdminPageFramework_Form_View___DebugInfo extends CConfiguratorAdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='sz-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
