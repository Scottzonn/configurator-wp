...
class CConfiguratorAdminPageFramework_Form_View___Section_Base extends CConfiguratorAdminPageFramework_Form_Base {
    ...
    public function getFieldsetOutput($aFieldset) {
        ...
        $_oFieldset = new CConfiguratorAdminPageFramework_Form_View___Fieldset($aFieldset, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
        $_sFieldOutput = $_oFieldset->get();
        return $_sFieldOutput;
    }
    }
    class CConfiguratorAdminPageFramework_Form_View___SectionTitle extends CConfiguratorAdminPageFramework_Form_View___Section_Base {
        ...
        private function _getToolTip($_aSectionset) {
            ...
            $_oToolTip = new CConfiguratorAdminPageFramework_Form_View___ToolTip($_aSectionset['tip'], $_sSectionTitleTagID);
        ...
        private function _getCollapseButton($aCollapsible) {
            ...
            return $this->getAOrB('button' === $this->getElement($aCollapsible, 'type', 'box'), "<span class='sz-collapsible-button sz-collapsible-button-expand' title='{$_sExpand}'>&#9658;</span>" . "<span class='sz-collapsible-button sz-collapsible-button-collapse' title='{$_sCollapse}'>&#9660;</span>", '');
        }
        ...
        private function _getFieldsetsInSectionTitleArea(array $aFieldsets, $iSectionIndex, $aFieldTypeDefinitions) {
            ...
            foreach ($aFieldsets as $_aFieldset) {
                ...
                $_oFieldsetOutputFormatter = new CConfiguratorAdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldset, $iSectionIndex, $aFieldTypeDefinitions);
    ...
    class CConfiguratorAdminPageFramework_Form_View___CollapsibleSectionTitle extends CConfiguratorAdminPageFramework_Form_View___SectionTitle {
        ...
        private function _getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer = 'sections', $iSectionIndex = null) {
            ...
            return $this->_getCollapsibleSectionsEnablerScript() . "<div " . $this->getAttributes(array('id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('sz-section-title', $this->getAOrB('box' === $aCollapsible['type'], 'accordion-section-title', ''), 'sz-collapsible-title', $this->getAOrB('sections' === $aCollapsible['container'], 'sz-collapsible-sections-title', 'sz-collapsible-section-title'), $this->getAOrB($aCollapsible['is_collapsed'], 'collapsed', ''), 'sz-collapsible-type-' . $aCollapsible['type']),) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
        }
        ...
        protected function _getCollapsibleSectionsEnablerScript() {
            ...
            self::$_bLoaded = true;
            new CConfiguratorAdminPageFramework_Form_View___Script_CollapsibleSection($this->oMsg);
        }
    }
