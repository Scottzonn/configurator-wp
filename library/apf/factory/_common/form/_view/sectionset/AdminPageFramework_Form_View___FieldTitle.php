...
class CConfiguratorAdminPageFramework_Form_View___FieldTitle extends CConfiguratorAdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_oInputTagIDGenerator = new CConfiguratorAdminPageFramework_Form_View___Generate_FieldInputID($aField, 0);
        $_aLabelAttributes = array('class' => $this->getClassAttribute('sz-field-title', $this->aClassSelectors), 'for' => $_oInputTagIDGenerator->get(),);
    ...
    private function _getFieldOutputsInFieldTitleAreaFromNestedFields($aField) {
        ...
        foreach ($aField['content'] as $_aNestedField) {
            ...
            $_oFieldset = new CConfiguratorAdminPageFramework_Form_View___Fieldset($_aNestedField, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
            $_sOutput.= $_oFieldset->get();
        }
        return $_sOutput;
    }
    private function _getToolTip($asTip, $sElementID) {
        $_oToolTip = new CConfiguratorAdminPageFramework_Form_View___ToolTip($asTip, $sElementID);
