...
abstract class CConfiguratorAdminPageFramework_Resource_Base extends CConfiguratorAdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'sz-style';
    protected $_sClassSelector_Script = 'sz-script';
    ...
    private function ___getCommonStyleTag($oCaller, $sIDPrefix) {
        $_sStyle = $this->addAndApplyFilters($oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), CConfiguratorAdminPageFramework_CSS::getDefaultCSS());
    ...
    private function ___getCommonIEStyleTag($oCaller, $sIDPrefix) {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), CConfiguratorAdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), CConfiguratorAdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle() {
        ...
        $this->_printCommonStyles('sz-style-common', get_class());
    ...
    public function _replyToAddScript() {
        ...
        $this->_printCommonScripts('sz-script-common', get_class());
