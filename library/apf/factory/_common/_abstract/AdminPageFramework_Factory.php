...
abstract class CConfiguratorAdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'CConfiguratorAdminPageFramework_Form_', 'oPageLoadInfo' => 'CConfiguratorAdminPageFramework_PageLoadInfo_', 'oResource' => 'CConfiguratorAdminPageFramework_Resource_', 'oHelpPane' => 'CConfiguratorAdminPageFramework_HelpPane_', 'oLink' => 'CConfiguratorAdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'CConfiguratorAdminPageFramework_Debug', 'oUtil' => 'CConfiguratorAdminPageFramework_FrameworkUtility', 'oMsg' => 'CConfiguratorAdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(CConfiguratorAdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return CConfiguratorAdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
    ...
    abstract class CConfiguratorAdminPageFramework_Factory_Model extends CConfiguratorAdminPageFramework_Factory_Router {
        public function __construct($oProp) {
    ...
    abstract class CConfiguratorAdminPageFramework_Factory_View extends CConfiguratorAdminPageFramework_Factory_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            new CConfiguratorAdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
        }
    ...
    abstract class CConfiguratorAdminPageFramework_Factory_Controller extends CConfiguratorAdminPageFramework_Factory_View {
    ...
    abstract class CConfiguratorAdminPageFramework_Factory extends CConfiguratorAdminPageFramework_Factory_Controller {
    }
