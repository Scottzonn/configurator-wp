...
abstract class CConfiguratorAdminPageFramework_Property_Base extends CConfiguratorAdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'sz' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aCConfiguratorAdminPageFramework'])) {
            $GLOBALS['aCConfiguratorAdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => CConfiguratorAdminPageFramework_Registry::NAME, 'sURI' => CConfiguratorAdminPageFramework_Registry::URI, 'sScriptName' => CConfiguratorAdminPageFramework_Registry::NAME, 'sLibraryName' => CConfiguratorAdminPageFramework_Registry::NAME, 'sLibraryURI' => CConfiguratorAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => CConfiguratorAdminPageFramework_Registry::getVersion(), 'sDescription' => CConfiguratorAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => CConfiguratorAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => CConfiguratorAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => CConfiguratorAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => CConfiguratorAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new CConfiguratorAdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }
