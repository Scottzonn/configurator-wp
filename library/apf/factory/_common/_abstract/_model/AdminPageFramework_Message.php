...
class CConfiguratorAdminPageFramework_Message {
    ...
    protected $_sTextDomain = 'sz';
    static private $_aInstancesByTextDomain = array();
    public static function getInstance($sTextDomain = 'sz') {
        $_oInstance = isset(self::$_aInstancesByTextDomain[$sTextDomain]) && (self::$_aInstancesByTextDomain[$sTextDomain] instanceof CConfiguratorAdminPageFramework_Message) ? self::$_aInstancesByTextDomain[$sTextDomain] : new CConfiguratorAdminPageFramework_Message($sTextDomain);
        self::$_aInstancesByTextDomain[$sTextDomain] = $_oInstance;
        return self::$_aInstancesByTextDomain[$sTextDomain];
    }
    public static function instantiate($sTextDomain = 'sz') {
        return self::getInstance($sTextDomain);
    }
    public function __construct($sTextDomain = 'sz') {
    ...
    private function ___doDummy() {
        __('The options have been updated.', 'sz');
        __('The options have been cleared.', 'sz');
        __('Export', 'sz');
        __('Export Options', 'sz');
        __('Import', 'sz');
        __('Import Options', 'sz');
        __('Submit', 'sz');
        __('An error occurred while uploading the import file.', 'sz');
        __('The uploaded file type is not supported: %1$s', 'sz');
        __('Could not load the importing data.', 'sz');
        __('The uploaded file has been imported.', 'sz');
        __('No data could be imported.', 'sz');
        __('Upload Image', 'sz');
        __('Use This Image', 'sz');
        __('Insert from URL', 'sz');
        __('Are you sure you want to reset the options?', 'sz');
        __('Please confirm your action.', 'sz');
        __('The specified options have been deleted.', 'sz');
        __('A problem occurred while processing the form data. Please try again.', 'sz');
        __('Not all form fields could not be sent. Please check your server settings of PHP <code>max_input_vars</code> and consult the server administrator to increase the value. <code>max input vars</code>: %1$s. <code>$_POST</code> count: %2$s', 'sz');
        __('Is it okay to send the email?', 'sz');
        __('The email has been sent.', 'sz');
        __('The email has been scheduled.', 'sz');
        __('There was a problem sending the email', 'sz');
        __('Title', 'sz');
        __('Author', 'sz');
        __('Categories', 'sz');
        __('Tags', 'sz');
        ...
        __('Date', 'sz');
        __('Show All', 'sz');
        __('Show All Authors', 'sz');
        __('Thank you for creating with', 'sz');
        __('and', 'sz');
        __('Settings', 'sz');
        __('Manage', 'sz');
        __('Select Image', 'sz');
        ...
        __('Insert', 'sz');
        __('Use This', 'sz');
        __('Return to Library', 'sz');
        __('%1$s queries in %2$s seconds.', 'sz');
        __('%1$s out of %2$s MB (%3$s) memory used.', 'sz');
        __('Peak memory usage %1$s MB.', 'sz');
        __('Initial memory usage  %1$s MB.', 'sz');
        __('The allowed maximum number of fields is {0}.', 'sz');
        __('The allowed minimum number of fields is {0}.', 'sz');
        __('Add', 'sz');
        __('Remove', 'sz');
        __('The allowed maximum number of sections is {0}', 'sz');
        __('The allowed minimum number of sections is {0}', 'sz');
        __('Add Section', 'sz');
        __('Remove Section', 'sz');
        __('Toggle All', 'sz');
        __('Toggle all collapsible sections', 'sz');
        __('Reset', 'sz');
        __('Yes', 'sz');
        __('No', 'sz');
        __('On', 'sz');
        ...
        __('Not Supported', 'sz');
        __('Functional', 'sz');
        __('Not Functional', 'sz');
        __('Too Long', 'sz');
        __('Acceptable', 'sz');
        __('No log found.', 'sz');
        __('The method is called too early: %1$s', 'sz');
        __('Debug Info', 'sz');
        __('Click here to expand to view the contents.', 'sz');
        __('Click here to collapse the contents.', 'sz');
        __('Loading...', 'sz');
        __('Please enable JavaScript for better user experience.', 'sz');
        __('Debug', 'sz');
        __('This information will be disabled when <code>WP_DEBUG</code> is set to <code>false</code> in <code>wp-config.php</code>.', 'sz');
        __('The ability to repeat sections is disabled.', 'sz');
        __('The ability to repeat fields is disabled.', 'sz');
        __('Warning.', 'sz');
        __('Submit the form.', 'sz');
        __('Please check this box if you want to proceed.', 'sz');
        __('No file is selected.', 'sz');
    }
    }
