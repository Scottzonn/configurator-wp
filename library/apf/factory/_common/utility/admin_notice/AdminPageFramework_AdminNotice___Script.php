...
class CConfiguratorAdminPageFramework_AdminNotice___Script extends CConfiguratorAdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.sz-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='sz-admin-notice-animation-container'></div>" );
