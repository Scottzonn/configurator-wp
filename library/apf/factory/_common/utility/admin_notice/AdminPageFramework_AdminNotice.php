...
class CConfiguratorAdminPageFramework_AdminNotice extends CConfiguratorAdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'sz-settings-notice-message', 'sz-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new CConfiguratorAdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
