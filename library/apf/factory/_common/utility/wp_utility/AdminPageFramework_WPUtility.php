...
class CConfiguratorAdminPageFramework_WPUtility_URL extends CConfiguratorAdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(CConfiguratorAdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(CConfiguratorAdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        if (false !== strpos($sFilePath, $_sContentDirPath)) {
            $_sRelativePath = CConfiguratorAdminPageFramework_Utility::getRelativePath(WP_CONTENT_DIR, $sFilePath);
            $_sRelativePath = preg_replace("/^\.[\/\\\]/", '', $_sRelativePath, 1);
            return content_url($_sRelativePath);
        }
        $_sRelativePath = CConfiguratorAdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
        $_sRelativePath = preg_replace("/^\.[\/\\\]/", '', $_sRelativePath, 1);
    ...
    class CConfiguratorAdminPageFramework_WPUtility_HTML extends CConfiguratorAdminPageFramework_WPUtility_URL {
    ...
    class CConfiguratorAdminPageFramework_WPUtility_Page extends CConfiguratorAdminPageFramework_WPUtility_HTML {
    ...
    class CConfiguratorAdminPageFramework_WPUtility_Hook extends CConfiguratorAdminPageFramework_WPUtility_Page {
    ...
    class CConfiguratorAdminPageFramework_WPUtility_File extends CConfiguratorAdminPageFramework_WPUtility_Hook {
    ...
    class CConfiguratorAdminPageFramework_WPUtility_Option extends CConfiguratorAdminPageFramework_WPUtility_File {
    ...
    class CConfiguratorAdminPageFramework_WPUtility_Meta extends CConfiguratorAdminPageFramework_WPUtility_Option {
    ...
    class CConfiguratorAdminPageFramework_WPUtility_SiteInformation extends CConfiguratorAdminPageFramework_WPUtility_Meta {
    ...
    class CConfiguratorAdminPageFramework_WPUtility_SystemInformation extends CConfiguratorAdminPageFramework_WPUtility_SiteInformation {
    ...
    class CConfiguratorAdminPageFramework_WPUtility extends CConfiguratorAdminPageFramework_WPUtility_SystemInformation {
