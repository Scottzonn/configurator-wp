...
class CConfiguratorAdminPageFramework_FrameworkUtility extends CConfiguratorAdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = CConfiguratorAdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return CConfiguratorAdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
    }
    class CConfiguratorAdminPageFramework_ArrayHandler extends CConfiguratorAdminPageFramework_FrameworkUtility {
        public $aData = array();
