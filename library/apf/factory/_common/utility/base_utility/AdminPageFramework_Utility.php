...
abstract class CConfiguratorAdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        CConfiguratorAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return CConfiguratorAdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        CConfiguratorAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return CConfiguratorAdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        CConfiguratorAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        CConfiguratorAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        CConfiguratorAdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'CConfiguratorAdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class CConfiguratorAdminPageFramework_Utility_VariableType extends CConfiguratorAdminPageFramework_Utility_Deprecated {
    ...
    abstract class CConfiguratorAdminPageFramework_Utility_String extends CConfiguratorAdminPageFramework_Utility_VariableType {
    ...
    abstract class CConfiguratorAdminPageFramework_Utility_Array extends CConfiguratorAdminPageFramework_Utility_String {
    ...
    abstract class CConfiguratorAdminPageFramework_Utility_ArrayGetter extends CConfiguratorAdminPageFramework_Utility_Array {
    ...
    abstract class CConfiguratorAdminPageFramework_Utility_ArraySetter extends CConfiguratorAdminPageFramework_Utility_ArrayGetter {
    ...
    abstract class CConfiguratorAdminPageFramework_Utility_Path extends CConfiguratorAdminPageFramework_Utility_ArraySetter {
    ...
    abstract class CConfiguratorAdminPageFramework_Utility_URL extends CConfiguratorAdminPageFramework_Utility_Path {
    ...
    abstract class CConfiguratorAdminPageFramework_Utility_File extends CConfiguratorAdminPageFramework_Utility_URL {
    ...
    abstract class CConfiguratorAdminPageFramework_Utility_SystemInformation extends CConfiguratorAdminPageFramework_Utility_File {
    ...
    abstract class CConfiguratorAdminPageFramework_Utility_HTMLAttribute extends CConfiguratorAdminPageFramework_Utility_SystemInformation {
    ...
    class CConfiguratorAdminPageFramework_Utility extends CConfiguratorAdminPageFramework_Utility_HTMLAttribute {
