...
abstract class CConfiguratorAdminPageFramework_UserMeta_Router extends CConfiguratorAdminPageFramework_Factory {
    ...
    abstract class CConfiguratorAdminPageFramework_UserMeta_Model extends CConfiguratorAdminPageFramework_UserMeta_Router {
        public function _replyToGetSavedFormData() {
            $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
            $_oMetaData = new CConfiguratorAdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
    ...
    abstract class CConfiguratorAdminPageFramework_UserMeta_View extends CConfiguratorAdminPageFramework_UserMeta_Model {
    ...
    abstract class CConfiguratorAdminPageFramework_UserMeta_Controller extends CConfiguratorAdminPageFramework_UserMeta_View {
        public function setUp() {
        }
    }
    abstract class CConfiguratorAdminPageFramework_UserMeta extends CConfiguratorAdminPageFramework_UserMeta_Controller {
        protected $_sStructureType = 'user_meta';
        public function __construct($sCapability = 'read', $sTextDomain = 'sz') {
