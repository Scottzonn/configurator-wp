...
class CConfiguratorAdminPageFramework_Form_widget extends CConfiguratorAdminPageFramework_Form {
    public $sStructureType = 'widget';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new CConfiguratorAdminPageFramework_Form_View___CSS_widget;
