...
class CConfiguratorAdminPageFramework_Property_widget extends CConfiguratorAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'sz', $sStructureType = '') {
