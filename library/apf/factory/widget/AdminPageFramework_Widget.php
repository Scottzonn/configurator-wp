...
abstract class CConfiguratorAdminPageFramework_Widget_Router extends CConfiguratorAdminPageFramework_Factory {
    ...
    abstract class CConfiguratorAdminPageFramework_Widget_Model extends CConfiguratorAdminPageFramework_Widget_Router {
        ...
        public function _replyToRegisterWidget() {
            ...
            $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName] = new CConfiguratorAdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
            $this->oProp->oWidget = $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName];
        }
    }
    abstract class CConfiguratorAdminPageFramework_Widget_View extends CConfiguratorAdminPageFramework_Widget_Model {
    ...
    abstract class CConfiguratorAdminPageFramework_Widget_Controller extends CConfiguratorAdminPageFramework_Widget_View {
    ...
    abstract class CConfiguratorAdminPageFramework_Widget extends CConfiguratorAdminPageFramework_Widget_Controller {
        protected $_sStructureType = 'widget';
        public function __construct() {
            $_sThisClassName = get_class($this);
            $_bAssumedAsWPWidget = 0 === func_num_args();
            $_aDefaults = array('', array(), 'edit_theme_options', 'sz');
