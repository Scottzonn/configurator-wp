 ...
 * @subpackage Configurator_Wp/public
 */
...
class Configurator_Wp_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/configurator-wp-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/configurator-wp-public.js', array( 'jquery' ), $this->version, true );
	 ...
	 *
	 * Shortcode can take attributes like [configurator-wp-shortcode attribute='123']
	 * Shortcodes can be enclosing content [configurator-wp-shortcode attribute='123']custom content[/configurator-wp-shortcode].
	 *
